...
for foo=1:2
    ...
    for f=1:4
        ...
        plot(cp,squeeze(mean_DENSE_mag(f,r,t)),lt{1},'Color',co(f,:),...
                'LineWidth',plot_line_width); hold on;
...
%         fprintf('HARP-I std nRMSE:  [%.1f, %.1f, %.1f, %.1f, %.1f]\n',squeeze(std_DENSE_mag(f,2:end)))
    ...
    h2(2) = plot(NaN,NaN,'--k','LineWidth',plot_line_width); hold off;
...
for foo=1:2
    ...
    for f=1:4
        ...
        plot(cp,squeeze(mean_DENSE_ang(f,r,t)),lt{1},'Color',co(f,:),...
                'LineWidth',plot_line_width); hold on;
...
for foo=1:2
    ...
    for f=1:4
        ...
        plot(cp,squeeze(mean_DENSE_CC(f,r,t)),lt{1},'Color',co(f,:),...
                'LineWidth',plot_line_width); hold on;
...
%     api.Axis = [0.75 3.25 0 25];
    api.Axis = [0.75 3.25 0 40];
    api.YAxisTickValues = 0:5:40;
    api.Legend1 = h1;
    api.Legend2 = h2;
    nice_plot_1(api);
...
for foo=1:2
    ...
    for f=1:4
        ...
        plot(cp,squeeze(mean_DENSE_RR(f,r,t)),lt{1},'Color',co(f,:),...
                'LineWidth',plot_line_width); hold on;
